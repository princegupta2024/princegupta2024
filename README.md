...
![MySQL](https://img.shields.io/badge/-MySQL-00758F?logo=mysql&logoColor=fff&style=flat-square)
![WordPress](https://img.shields.io/badge/-WordPress-21759B?logo=wordpress&logoColor=fff&style=flat-square)
![Shopify](https://img.shields.io/badge/-Shopify-96BF48?logo=shopify&logoColor=fff&style=flat-square)
...
> A few highlights from my work, mixing personal, client, and freelance projects. Each link opens the live site.

### 🏋️‍♂️ [Gym Management](https://princegupta2024.github.io/gym-management/)
**Tech Stack:** HTML, CSS, JavaScript  
🎯 Developed a fully responsive landing page for a fitness center to attract new members, featuring dynamic service cards and clear calls-to-action.  
...
**Tech Stack:** HTML, CSS, JavaScript  
📘 Designed a clean, modern template for educational institutions with an intuitive layout for course listings, instructor profiles, and student testimonials.  
...
**Tech Stack:** HTML, CSS, JavaScript  
💊 Crafted a professional e-commerce landing page for a medical supplier, focusing on a trustworthy UI and easy navigation for product categories.  
...
**Tech Stack:** HTML, CSS, JavaScript  
🔄 Built a lightweight, reusable tab component from scratch using vanilla JavaScript, engineered for easy integration and customization in any web project.  
...
🏢 Developed a corporate website for an industrial abrasives manufacturer, improving their online presence and lead generation.  
_Source: Client project (private repository)_

---

### 🛍️ [NILA Shop](https://nila.shop/)
**Tech Stack:** Shopify  
🛒 Built a custom Shopify storefront with optimized product pages and a streamlined checkout process to increase conversion rates.  
_Source: Client project (private repository)_
...
⚙️ Delivered a professional company website for a petroleum service provider to showcase their services and establish industry credibility.  
_Source: Client project (private repository)_
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=princegupta2024&show_icons=true&theme=tokyonight&hide_border=true&rank_icon=github" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=princegupta2024&layout=compact&theme=tokyonight&hide_border=true" width="48%" />
</p>
...
- 🎓 Currently deepening my skills in **TypeScript** & **Next.js**.
- 💼 Available for freelance and remote full-time opportunities.
- 💬 Ask me about React, WordPress, Shopify, performance optimization, and responsive UI.
- 🧠 Fun fact: I enjoy refactoring complex UI flows into simple, reusable components.
